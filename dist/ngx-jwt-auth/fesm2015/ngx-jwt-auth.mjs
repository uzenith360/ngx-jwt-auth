    ...
    forgotPassword(email) {
        return this.http.post(this.config.forgotPasswordUrl, { email }).pipe(HttpHelpers.retry(), catchError((err, caught) => {
            switch (err.status) {
                ...
                case 0:
                default:
                    return throwError(() => { var _a, _b, _c, _d, _e, _f, _g, _h; return new HttpError((_h = (_g = (_e = (((_b = (_a = err.error) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.join) && ((_d = (_c = err.error) === null || _c === void 0 ? void 0 : _c.message) === null || _d === void 0 ? void 0 : _d.join(', ')))) !== null && _e !== void 0 ? _e : (_f = err.error) === null || _f === void 0 ? void 0 : _f.message) !== null && _g !== void 0 ? _g : err === null || err === void 0 ? void 0 : err.message) !== null && _h !== void 0 ? _h : 'Problem sending otp, please check network and try again', err.status); });
            }
            ;
        }));
    }
    resetPassword(email, password, code) {
        return this.http.put(this.config.resetPasswordUrl, {
            ...
            switch (err.status) {
                ...
                case 0:
                default:
                    return throwError(() => { var _a, _b, _c, _d, _e, _f, _g, _h; return new HttpError((_h = (_g = (_e = (((_b = (_a = err.error) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.join) && ((_d = (_c = err.error) === null || _c === void 0 ? void 0 : _c.message) === null || _d === void 0 ? void 0 : _d.join(', ')))) !== null && _e !== void 0 ? _e : (_f = err.error) === null || _f === void 0 ? void 0 : _f.message) !== null && _g !== void 0 ? _g : err === null || err === void 0 ? void 0 : err.message) !== null && _h !== void 0 ? _h : 'Problem reseting, please check network and try again', err.status); });
            }
            ;
        }));
    }
...
class JwtAuthService {
    ...
    decode(jwt) {
        try {
            const accessToken = jwt === null || jwt === void 0 ? void 0 : jwt.access_token;
            return !!accessToken
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AuthModalComponent, decorators: [{
        ...
        return [{ type: i1$1.MatDialogRef, decorators: [{
                        type: Optional
        ...
        if (dontCheckAuth || this.isAuth()) {
            ...
            return new Promise((resolve, reject) => {
                this.authDialogService
                    ...
                    resolve(jwtAndUser);
                }).catch((err) => reject(new AuthError(err === null || err === void 0 ? void 0 : err.message)));
            });
        }
        else {
